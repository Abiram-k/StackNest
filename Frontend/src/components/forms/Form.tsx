...
import GoogleAuth from "../auth/googleLoginbtn";
    ...
    >
      ...
      <div className="grid gap-6">
        ...
        <Button
          ...
          } w-full  bg-primary-500 dark:bg-primary-600 hover:bg-primary-600/90 dark:hover:bg-primary-600/90 cursor-pointer`}
        >
