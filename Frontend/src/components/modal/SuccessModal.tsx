...
const SuccessModal: React.FC<SuccessModalProps> = ({
  ...
  message = "Your Account has been successfully updated! You can now use your new password to log in. Please keep it secure and avoid sharing it with anyone.",
  buttonText = "Continue",
}) => {
    ...
    <div className="fixed inset-0 flex items-center justify-center z-50">
      ...
      <div className="relative bg-gray-900 rounded-3xl w-full max-w-md mx-4 overflow-hidden shadow-xl">
        <div className="px-6 py-8 text-center">
          ...
          <p className="text-gray-400 text-sm mt-4 mb-6 max-w-xs mx-auto">{message}</p>
