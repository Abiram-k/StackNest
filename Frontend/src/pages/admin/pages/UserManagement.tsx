...
// import { LayoutGrid, Users, CreditCard, Flag, Home, DollarSign, Calendar, Bell, FileText, Globe, LogOut, Search, ChevronLeft, ChevronRight } from 'lucide-react'
...
//   // Sample user data
//   const userData = [
//     { id: 1, name: "Ananthu1", email: "user1@email.com", phone: "9656123456", blocked: false },
//     { id: 2, name: "Ananthu2", email: "user2@email.com", phone: "9656123456", blocked: false },
//     { id: 3, name: "Ananthu3", email: "user3@email.com", phone: "9656123456", blocked: false },
//     { id: 4, name: "Ananthu4", email: "user4@email.com", phone: "9656123456", blocked: false },
//     { id: 5, name: "Ananthu5", email: "user5@email.com", phone: "9656123456", blocked: false },
//     { id: 6, name: "Ananthu6", email: "user6@email.com", phone: "9656123456", blocked: false },
//     { id: 7, name: "Ananthu7", email: "user7@email.com", phone: "9656123456", blocked: false },
//     { id: 8, name: "Ananthu8", email: "user8@email.com", phone: "9656123456", blocked: false },
//     { id: 9, name: "Ananthu9", email: "user9@email.com", phone: "9656123456", blocked: false },
//   ]
...
//         <h1 className="text-2xl font-bold mb-8 border-b pb-2">User Management</h1>
...
//                   page === 1 ? 'bg-blue-600 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
//                 }`}
