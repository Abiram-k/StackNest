// import { Trash2, LogOut, User, ShoppingBag, Flag, LayoutGrid, CreditCard, BarChart2, Bell, FileText, Globe } from 'lucide-react'
...
//           <NavItem icon={<LayoutGrid size={20} />} label="Rooms" active />
...
//                       <p className="text-sm">
//                         A space for developers to discuss programming languages, best practices, and team optimization techniques. Share your projects, get feedback, and collaborate on open-source contributions.
//                       </p>
//                     </div>
//                   </div>
//                 </div>
...
//   return (
//     <div className={`flex items-center px-4 py-3 rounded-md ${active ? 'bg-blue-600 text-white' : 'text-gray-700 hover:bg-gray-100'}`}>
